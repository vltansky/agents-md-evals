...
Evaluate and optimize AGENTS.md/CLAUDE.md instruction files through controlled A/B testing. Discover which rules actually change model behavior vs. waste context tokens.
